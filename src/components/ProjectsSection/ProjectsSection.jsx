    ...
    <div className="flex flex-col w-full h-auto  px-20 py-5 mt-40 items-center justify-center gap-10">
      ...
      <div className="flex flex-col gap-9">
        <div className=" w-full flex flex-wrap gap-4">
          <div className="w-[900px] h-[600px] bg-red-400 rounded-2xl hover:backdrop-blur-lg"></div>
          <div className="w-[500px] h-[600px] bg-red-100 rounded-2xl hover:backdrop-blur-lg"></div>
        </div>
        <div className="w-full flex flex-wrap gap-4">
          <div className="w-[500px] h-[600px] bg-red-300 rounded-2xl hover:backdrop-blur-lg"></div>
          <div className="w-[900px] h-[600px] bg-red-800 rounded-2xl hover:backdrop-blur-lg"></div>
        </div>
      </div>
